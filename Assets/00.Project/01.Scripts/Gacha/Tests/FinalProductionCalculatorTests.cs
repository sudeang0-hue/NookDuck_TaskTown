...
namespace TaskTown.Gacha.Tests
{
    ...
    {
        private static AnimalData CreateAnimal(string id, float baseCoinPerSecond, float levelBonusRatePerLevel = 0.2f)
        {
        ...
        private static ToolData CreateTool(float baseCoinPerSecond, float levelBonusRatePerLevel, string specialAnimalId, float bonusRate)
        {
        ...
        {
            AnimalData animal = CreateAnimal("A_CAT", 2f);
        ...
        {
            AnimalData animal = CreateAnimal("A_CAT", 2f);
            ToolData tool = CreateTool(3f, 0.2f, "A_CAT", 0.5f);
