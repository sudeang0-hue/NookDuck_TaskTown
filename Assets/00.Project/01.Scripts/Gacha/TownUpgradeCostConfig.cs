...
namespace TaskTown.Gacha
{
    ...
    public class TownUpgradeCostConfig
    {
        ...
        {
            new LevelCostEntry { townLevelThreshold = 1, cost = 220000 },
            new LevelCostEntry { townLevelThreshold = 2, cost = 1000000 },
            new LevelCostEntry { townLevelThreshold = 3, cost = 1750000 },
            new LevelCostEntry { townLevelThreshold = 4, cost = 2200000 },
            new LevelCostEntry { townLevelThreshold = 5, cost = 2900000 },
            new LevelCostEntry { townLevelThreshold = 6, cost = 4350000 },
            new LevelCostEntry { townLevelThreshold = 7, cost = 5800000 },
            new LevelCostEntry { townLevelThreshold = 8, cost = 6000000 },
            new LevelCostEntry { townLevelThreshold = 9, cost = 15500000 },
        };
