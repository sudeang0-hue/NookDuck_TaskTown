...
namespace TaskTown.KDH
{
    ...
    public class OfflineRewardManager : MonoBehaviour
    {
        ...
        private void GrantOfflineRewardIfDue()
        {
            ...
            if (RealProductionTicker.Instance != null && CoinWallet != null)
            {
                float productionRate = RealProductionTicker.Instance.CalculateTotalCoinPerSecond();
                long reward = OfflineRewardCalculator.CalculateRewardCoins(productionRate, offlineDuration);
