...
namespace UI
{
    public class UIController_Gacha : MonoBehaviour
    {
        ...
        [Header("동물 뽑기 버튼")]
        [SerializeField] private Button animalOnePickButton;  // 동물 1회 뽑기 (튜토리얼 강조용)
        ...
        [Header("도구 뽑기 버튼")]
        [SerializeField] private Button toolOnePickButton;    // 도구 1회 뽑기 (튜토리얼 강조용)
        ...
        /// 실제 뽑기 실행은 GachaSystemBridge가 담당합니다.
        /// </summary>
