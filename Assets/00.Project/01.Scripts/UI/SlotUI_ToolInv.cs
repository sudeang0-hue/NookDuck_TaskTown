...
public class SlotUI_ToolInv : SlotUIBase
{
    ...
    /// 동물 슬롯 정보 갱신
    /// </summary>
    public void SetToolSlot(string id, string displayName, Sprite icon, int level, int currentCount, int needCount)
    {
    ...
    public void ToolLevelUpButtonClick()
    {
        Debug.Log("도구 레벨업 로직 실행. 이후 버튼 비활성화");
    }
